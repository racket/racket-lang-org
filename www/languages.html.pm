...
Languages added to the Racket package system are automatically added to the ◊link["http://docs.racket-lang.org/"]{Racket Documentation}. 

The following is a selection of of langiuages built with Racket including languages with different syntax (Java, Algol 60), semantics(Racklog and Datalog), tooling (ffmpeg for Video and solvers for Rosette), and targets other than the racket platform (Javascript, 6502).
...
◊div{Meta-DSL's}
◊p[#:style "font-size: 80%;margin-top: 1rem;color:gray;width:80%;line-height:1.5"]{
'Meta-DSL's' are languages that can be used to create languages.}}
