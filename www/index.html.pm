...
◊div[#:class "container-fluid vertical-in-smartphones-horizontal-otherwise"]{
 ◊div[#:style "margin-left: 1em"]{
   ◊link["https://blog.racket-lang.org/2023/02/racket-v8-8.html"]{Racket version 8.8} is available.}
  ...
  ◊div[#:class "container-fluid"  #:style "font-size:90%"]{
   ...
   ◊table{
    ...
    ◊td{ ◊div[#:class "smartphone-only"]{Community} ◊p{
      ...
      ◊link[#:rel "me" "https://mastodon.social/@racketlang"]{Mastodon}, ◊link["https://twitter.com/racketlang"]{Twitter} and ◊link["https://blog.racket-lang.org/"]{Blog}
      Keep in touch.
