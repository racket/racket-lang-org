...
#racket IRC on freenode.net; GitHub repositories under github.com/racket; and all forums under lists.racket-lang.org (including https://groups.google.com/forum/#!forum/racket-users). 

For other projects adopting the Rust Code of Conduct, please contact the maintainers of those projects for enforcement. If you wish to use this code of conduct for your own project, consider explicitly mentioning your moderation policy or making a copy with your own moderation policy so as to avoid confusion.

Adapted from the RacketCon 2018 Friendly Environment Policy and the ◊link["https://www.rust-lang.org/policies/code-of-conduct"]{Rust Code of conduct} which in turn was adapted from the Node.js Policy on Trolling as well as the Contributor Covenant v1.3.0.
