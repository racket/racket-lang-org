...
#:bio
@para{Sage is a programmer by hobby and trade. If you bought a car, educated kids, or avoided a lawsuit, then you may have used his code.}
]
...
#:bio
@para{Lukas is a PL PhD student at Northwestern. He’s graduating this winter and is on the job market.}
]
...
#:bio
@para{Adam Perlin is a software engineer in Microsoft Azure. He completed BS and MS degrees in Computer Science at Cal Poly, San Luis Obispo with a Master’s thesis focused on Racket to Wasm translation.}
]
...
#:bio
@para{Micah is a student at Grinnell College with interests in compilers, functional programming, writing and education.}
]
