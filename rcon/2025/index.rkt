...
(define location "Massachusetts, USA")
...
(content
     (banner
      ...
      @subtitle{@p-location{University of Massachusetts}}
      @specific-location{Massachusetts, @'nbsp United States}
      )
...
(column
 ...
 (section
   ...
   @paragraph{The RacketCon 2025 is organised by a team of volunteers: Matthew Flatt, Robby Findler, Siddhartha Kasivajhula, Stephen De Gabrielle and @a[#:href "https://forms.gle/omJAjAQ6xJLjsw3z8"]{Your name here}
