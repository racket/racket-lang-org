...
col-2 {
 ...
 flex-wrap: wrap;
   width: 100%;
/*  color:gray;  */ /* reinstate these in home css */
 /* font-size: 90%; */
}

/* reinstate this in home css */
/*
li {
  display: block;
  width: 50%;
...
img.legacy-logo {
  ...
  display: inline-block;
  width: 100%;
  transform: translate(0.15em,0.45em);
  margin-right: 0.25rem;
}
...
article pre { ◊; prevents code boxes from blowing up flex layout
  width: 38rem;
  overflow-x: hidden;
}
